 ...
 * @public
 */
export declare class ChangeStream<TSchema extends Document> extends TypedEventEmitter<ChangeStreamEvents> {
    pipeline: Document[];
...
export declare class Collection<TSchema extends Document = Document> {
     ...
     * @param callback - An optional callback, a Promise will be returned if none is provided
     */
    updateOne(filter: Filter<TSchema>, update: UpdateQuery<TSchema> | Partial<TSchema>): Promise<UpdateResult | Document>;
    updateOne(filter: Filter<TSchema>, update: UpdateQuery<TSchema> | Partial<TSchema>, callback: Callback<UpdateResult | Document>): void;
    updateOne(filter: Filter<TSchema>, update: UpdateQuery<TSchema> | Partial<TSchema>, options: UpdateOptions): Promise<UpdateResult | Document>;
    updateOne(filter: Filter<TSchema>, update: UpdateQuery<TSchema> | Partial<TSchema>, options: UpdateOptions, callback: Callback<UpdateResult | Document>): void;
    /**
     ...
     * @param callback - An optional callback, a Promise will be returned if none is provided
     */
    updateMany(filter: Filter<TSchema>, update: UpdateQuery<TSchema>): Promise<UpdateResult | Document>;
    updateMany(filter: Filter<TSchema>, update: UpdateQuery<TSchema>, callback: Callback<UpdateResult | Document>): void;
    updateMany(filter: Filter<TSchema>, update: UpdateQuery<TSchema>, options: UpdateOptions): Promise<UpdateResult | Document>;
    updateMany(filter: Filter<TSchema>, update: UpdateQuery<TSchema>, options: UpdateOptions, callback: Callback<UpdateResult | Document>): void;
    /**
    ...
    distinct<Key extends keyof WithId<TSchema>>(key: Key, filter: Filter<TSchema>, callback: Callback<any[]>): void;
    distinct<Key extends keyof WithId<TSchema>>(key: Key, filter: Filter<TSchema>, options: DistinctOptions): Promise<any[]>;
    distinct<Key extends keyof WithId<TSchema>>(key: Key, filter: Filter<TSchema>, options: DistinctOptions, callback: Callback<any[]>): void;
    /**
     ...
     * @param callback - An optional callback, a Promise will be returned if none is provided
     */
    findOneAndUpdate(filter: Filter<TSchema>, update: UpdateQuery<TSchema>): Promise<ModifyResult<TSchema>>;
    findOneAndUpdate(filter: Filter<TSchema>, update: UpdateQuery<TSchema>, callback: Callback<ModifyResult<TSchema>>): void;
    findOneAndUpdate(filter: Filter<TSchema>, update: UpdateQuery<TSchema>, options: FindOneAndUpdateOptions): Promise<ModifyResult<TSchema>>;
    findOneAndUpdate(filter: Filter<TSchema>, update: UpdateQuery<TSchema>, options: FindOneAndUpdateOptions, callback: Callback<ModifyResult<TSchema>>): void;
    /**
     ...
     * @param callback - An optional callback, a Promise will be returned if none is provided
     */
    mapReduce<TKey = any, TValue = any>(map: string | MapFunction<TValue>, reduce: string | ReduceFunction<TKey, TValue>): Promise<Document | Document[]>;
    mapReduce<TKey = any, TValue = any>(map: string | MapFunction<TValue>, reduce: string | ReduceFunction<TKey, TValue>, callback: Callback<Document | Document[]>): void;
    mapReduce<TKey = any, TValue = any>(map: string | MapFunction<TValue>, reduce: string | ReduceFunction<TKey, TValue>, options: MapReduceOptions<TKey, TValue>): Promise<Document | Document[]>;
    mapReduce<TKey = any, TValue = any>(map: string | MapFunction<TValue>, reduce: string | ReduceFunction<TKey, TValue>, options: MapReduceOptions<TKey, TValue>, callback: Callback<Document | Document[]>): void;
     ...
     * @param callback - An optional callback, a Promise will be returned if none is provided
     */
    update(selector: Filter<TSchema>, update: UpdateQuery<TSchema>, options: UpdateOptions, callback: Callback<Document>): Promise<UpdateResult> | void;
    /**
     * Remove documents.
     *
...
export declare class Db {
    ...
    collection<TSchema extends Document = Document>(name: string, callback: Callback<Collection<TSchema>>): void;
    collection<TSchema extends Document = Document>(name: string, options: CollectionOptions, callback: Callback<Collection<TSchema>>): void;
    /**
...
export declare type Filter<TSchema> = Partial<TSchema> & Document;
...
/** @public */
export declare const MONGO_CLIENT_EVENTS: readonly ["connectionPoolCreated", "connectionPoolClosed", "connectionCreated", "connectionReady", "connectionClosed", "connectionCheckOutStarted", "connectionCheckOutFailed", "connectionCheckedOut", "connectionCheckedIn", "connectionPoolCleared", ...("error" | "serverHeartbeatStarted" | "serverHeartbeatSucceeded" | "serverHeartbeatFailed" | "commandStarted" | "commandSucceeded" | "commandFailed" | "close" | "serverOpening" | "serverClosed" | "serverDescriptionChanged" | "topologyOpening" | "topologyClosed" | "topologyDescriptionChanged" | "timeout")[]];
...
/** @public */
export declare type MongoClientEvents = Pick<TopologyEvents, typeof MONGO_CLIENT_EVENTS[number] | 'open'>;
...
export declare class Monitor extends TypedEventEmitter<MonitorEvents> {
    ...
    [kCancellationToken_2]: CancellationToken;
...
/** @public */
export declare interface ProjectionOperators {
    $elemMatch?: Document;
...
/** @public */
export declare type ReduceFunction<TKey = ObjectId, TValue = Document> = (key: TKey, values: TValue[]) => TValue;
...
export declare type UpdateQuery<TSchema> = Document;
...
/** @public */
export declare type WithTransactionCallback<T> = (session: ClientSession) => Promise<T> | void;
