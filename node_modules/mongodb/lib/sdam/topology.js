...
function srvPollingHandler(topology) {
    return function handleSrvPolling(ev) {
        ...
        topology.emit(Topology.SERVER_DESCRIPTION_CHANGED, 
        // TODO(NODE-3272): This server description changed event is emitting a TopologyDescriptionChangeEvent
        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
        // @ts-expect-error
        new events_1.TopologyDescriptionChangedEvent(topology.s.id, previousTopologyDescription, topology.s.description));
    };
}
